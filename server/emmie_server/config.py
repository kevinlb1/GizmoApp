...
def load_settings(shell_variant: str | None = None) -> dict:
    ...
    settings = {
        ...
        "ADMIN_NOTES": [
            ...
            "Select the active shell through EMMIE_SHELL or an explicit WSGI entry point.",
        ],
    }
    settings.update(shell_settings(shell_variant or os.getenv("EMMIE_SHELL", DEFAULT_SHELL)))
    return settings
